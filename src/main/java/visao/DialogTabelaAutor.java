...
public class DialogTabelaAutor extends JDialog implements ActionListener
{
	...
	public DialogTabelaAutor(DialogAutor dialogAutor)
	{
		super(dialogAutor);
		
		this.dialogAutor = dialogAutor;
		
		setTitle("Pesquisa de Autores");
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		autorModel.setNomeAutor(nomeTextField.getText());
		...
		new ButtonColumn(table, 5, this, dialogAutor);

        // Designa um novo editor para a coluna da tabela
        // Este novo editor é um ComboBox
		sexoColumn = columnModel.getColumn(AutorModel.COLUNA_SEXO);
		sexoColumn.setCellEditor(new DefaultCellEditor(sexoComboBox));
		
        // Designa um novo editor para a coluna da tabela
        // Este novo editor é um ComboBox
		idadeColumn = columnModel.getColumn(AutorModel.COLUNA_IDADE);
